...
let entrylist = [
  {
    ...
    user: {
      ...
      username: 'descire',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/5/28/163a64ba4279f889?w=1239&h=1209&f=png&s=115753',
      objectId: '57c5ae26c4c9710061a1defc'
    },
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/21/169a00a26cabf2b9?w=900&h=383&f=png&s=69612',
    original: true,
    hotIndex: 557.0669,
    content:
    ...
    viewsCount: 375,
    summaryInfo:
      '  通常情况下，HTML 中的图片资源会自上而下依次加载，而部分图片只有在用户向下滚动页面的场景下才能被看见，否则这部分图片的流量就白白浪费了。   所以，对于那些含有大量图片资源的网站，会采用“按需加载”的方式，也就是当图片资源出现在视口区域内，才会被加载，这样可能会影响一丢丢用户体验，但是能大...',
    isCollected: false
  },
  {
    collectionCount: 6,
    ...
    user: {
      ...
      username: '程序猿DD_',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2019/3/21/1699f0e5d13e9789?w=568&h=568&f=jpeg&s=33909',
    ...
    hotIndex: 396.0943,
    content:
      '今天重读了Martin Fowler的《Microservices》，在此记录一下对九大特性的理解。 组件，是一个可以独立更换和升级的单元。就像PC中的CPU、内存、显卡、硬盘一样，独立且可以更换升级而不影响其他单元。 在“微服务”架构中，需要我们对服务进行组件化分解。服务，是…',
    title: '《微服务》九大特性重读笔记',
    lastCommentTime: '1970-01-01T00:00:00.Z',
    type: 'article',
    english: false,
    ...
    viewsCount: 334,
    summaryInfo:
      '今天重读了Martin Fowler的《Microservices》，在此记录一下对九大特性的理解。 组件，是一个可以独立更换和升级的单元。就像PC中的CPU、内存、显卡、硬盘一样，独立且可以更换升级而不影响其他单元。 在“微服务”架构中，需要我们对服务进行组件化分解。服务，是一种进程外的组件，它...',
    isCollected: false
  },
  {
    collectionCount: 62,
    ...
    user: {
      ...
      username: '大漠火狼',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/4/15/162c79f54b6da258?w=256&h=256&f=jpeg&s=21755',
  ...
  },
  {
    ...
    user: {
      community: {
        wechat: {
          avatarLarge:
            'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJDSY5xBJ2PH6cYQ8t8H9eSAMcRcgn6tINDNk23PFAynU7gmJrHvRVJISRibRvyMjfFeOO0UJ8zNNA/132'
        }
      },
      ...
      username: 'snowLu',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/12/26/167e98a390f33011?w=220&h=220&f=jpeg&s=9620',
    ...
    viewsCount: 239,
    summaryInfo:
      '上一篇文章中介绍了几种常见链表的含义，今天介绍下如何写出正确的链表代码。 我们一般设计的链表有两个类。 类用来表示节点， 类提供了一些辅助方法，比如说结点的增删改查，以及显示列表元素等方法。接下来看看如何用 代码表示一个链表。 类包含两个属性： 用来保存节点上的数据， 用来保存指向下一个节点的链接...',
    isCollected: false
  },
  {
    collectionCount: 226,
    ...
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/21/1699e117ba6de740?w=800&h=600&f=png&s=423939',
    original: true,
    hotIndex: 8003.8637,
    content:
      '大家知道，React 现在已经在前端开发中占据了主导的地位。优异的性能，强大的生态，让其无法阻挡。博主面的 5 家公司，全部是 React 技术栈。据我所知，大厂也大部分以 React 作为主技术栈。React 也成为了面试中并不可少的一环。 React 也是现如今最流行的前端…',
  ...
  },
  {
    ...
    user: {
      ...
      username: 'shanyue',
      avatarLarge:
        'https://leancloud-gold-cdn.xitu.io/bdfecd06f90e24f88946.jpeg?imageView/2/w/100/h/100/q/80/format/png',
    ...
    hotIndex: 8249.6187,
    content:
      '刚开始调研服务器渲染写了一个 demo，正好对诗词感兴趣，就做了一个关于诗词的站点，越写越大，demo 变成了 DEMO，总的来说还是特别简单。随手挂到了服务器下。 有了前端自然需要服务器端支持，遵循着简单方便好用易于上手的原则，在 parse-server 与 graphql…',
    ...
    viewsCount: 5902,
    summaryInfo:
      '刚开始调研服务器渲染写了一个 demo，正好对诗词感兴趣，就做了一个关于诗词的站点，越写越大，demo 变成了 DEMO，总的来说还是特别简单。随手挂到了服务器下。 技术栈 👉 Next.js + React + ApolloClient + Docker + Docker Compose 有了前...',
    isCollected: false
  },
  {
    collectionCount: 29,
    ...
    user: {
      ...
      username: '慕晨同学',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/8/25/1657094c37a50788?w=514&h=300&f=jpeg&s=10309',
    ...
    hotIndex: 1061.9296,
    content:
      '在codewars上做了一道斐波那契数列求和的题目，做完之后做了一些简单的优化和用另一种方法实现。 以上函数使用递归的方式进行斐波那契数列求和，但效率十分低，很多值会重复求值。题目要求使用 memoization方案进行优化。 memoization方案在《JavaScript…',
    ...
    viewsCount: 739,
    summaryInfo:
      '在codewars上做了一道斐波那契数列求和的题目，做完之后做了一些简单的优化和用另一种方法实现。  以上函数使用递归的方式进行斐波那契数列求和，但效率十分低，很多值会重复求值。题目要求使用 memoization方案进行优化。 memoization方案在《JavaScript模式》和《Java...',
    isCollected: false
  },
  {
    collectionCount: 10,
    ...
    autoPass: true,
    originalUrl:
      'http://blog.didispace.com/Spring-Boot%E5%BF%AB%E9%80%9F%E5%BC%80%E5%8F%91%E5%88%A9%E5%99%A8%EF%BC%9ASpring-Boot-CLI/',
    ...
    viewsCount: 1123,
    summaryInfo:
      'Spring Boot CLI（Command Line Interface）是一个命令行工具，您可以用它来快速构建Spring原型应用。通过Spring Boot CLI，我们可以通过编写Groovy脚本来快速的构建出Spring Boot应用，并通过命令行的方式将其运行起来。下来，我们来学习一...',
    isCollected: false
  },
  {
    collectionCount: 127,
    ...
    user: {
      community: {
        weibo: {
          selfDescription:
            '我其实本想做个生物学者的。个人网站：http://www.zhangxinxu.com',
          uid: '1263362863',
    ...
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/20/16999a2cb1469d76?w=484&h=300&f=jpeg&s=17488',
    original: false,
    hotIndex: 4314.5911,
    content:
      '很多人有学不进去，没时间学的问题，加上之前断断续续有很多人咨询我关于如何学习的问题，我觉得可以好好讲讲我对于学习这件事的一些经验和看法。',
    title: '学不进去，没时间学怎么办？',
    ...
    viewsCount: 2892,
    summaryInfo:
      '这篇文章发布于 2019年03月19日，星期二，2:36 下午，归类于 散文随笔。 阅读 1074 次, 今日 400 次 招聘高峰季，最近面试了一些人，聊到关于学习话题的时候，发现很多人有学不进去，没时间学的问题，加上之前断断续续有很多人咨询我关于如何学习的问题，我觉得可以好好讲讲我对于学习这件...',
    isCollected: false
  },
  {
    collectionCount: 35,
    ...
    user: {
      ...
      username: 'dendoink',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2019/1/23/168799008cdf2228?w=819&h=819&f=jpeg&s=410288',
      objectId: '585a2f52128fe10069ba1b95'
    },
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/20/169993200cdd5ddc?w=1508&h=1170&f=png&s=2818709',
    original: true,
    hotIndex: 2128.2367,
    content:
      '在学习前端的时候，我总是能听到很多高级词汇，比如今天会聊到的 函数式编程(Functional Programming) & 高阶函数 (Higher-order function) 。 但是当你真正的理解什么是 函数式编程 & 高阶函数 的时候，也许会发现，你几乎每天都会用到…',
    ...
    viewsCount: 1726,
    summaryInfo:
      '在学习前端的时候，我总是能听到很多高级词汇，比如今天会聊到的 & 。但是当你真正的理解什么是 & 的时候，也许会发现，你几乎每天都会用到它，只是你不知道那就是高阶函数 / 函数式编程。 在 中，函数是一种值，举个例子： 我们把一个函数作为值，赋给了变量 ,这在我们的代码中很常见对吗？ 粗看很不好理...',
    isCollected: false
  },
  {
    collectionCount: 80,
    ...
    user: {
      community: {
        weibo: {
          ...
          username: '崔红保',
          avatarLarge:
            'http://tva3.sinaimg.cn/crop.0.0.1242.1242.180/4e5bc317jw8etwk0bckqyj20yi0yiq6q.jpg'
        },
        github: {
          username: 'hbcui1984',
      ...
      username: 'CHB',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/3/28/1626cb04ba5685c9?w=1372&h=572&f=jpeg&s=254259',
    ...
    hotIndex: 6459.0405,
    content:
      '多次论证、数月研发，我们重写部分Vue底层、重构uni-app框架，实现了微信端性能翻倍及更多Vue语法支持。 随着使用uni-app的开发者愈来愈多，业务复杂度不断增加，不少开发者抱怨uni-app支持的vue语法少，某些场景性能有问题（特别是页面存在复杂组件的情况），这些问…',
    ...
    viewsCount: 5457,
    summaryInfo:
      '多次论证、数月研发，我们重写部分底层、重构框架，实现了微信端性能翻倍及更多VUE语法支持。 在初期借鉴了，实现了微信小程序端的快速兼容，感谢美团点评团队对于开源社区的贡献！ 随着使用的开发者愈来愈多，业务复杂度不断增加，不少开发者抱怨支持的vue语法少，某些场景性能有问题（特别是页面存在复杂组件的...',
    isCollected: false
  },
  {
    collectionCount: 124,
    ...
    user: {
      community: {
        wechat: {
          avatarLarge:
            'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLOzNmktbnuJkYTia5Dicb7nENsdUbuE6pFsxvQAtZHichDWaFWqoG4zMZyJ6TXicEib8VYOV0yI7IBYrQ/132'
        },
        github: {
          username: 'wanqihua',
      ...
      username: '小生方勤',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2019/1/14/1684b8cf1ed7df86?w=523&h=522&f=jpeg&s=32607',
    ...
    viewsCount: 3421,
    summaryInfo:
      '去年圣诞节产品提了一个活动需求，其中有一个下雪的背景动画。在做这个动画的过程中加深了对 canvas 动画的一些了解，在这里我仅是抛砖引玉的分享一下，欢迎各位大佬批评。 代码已上传至 github ，感兴趣的可以 clone 代码到本地运行。望给个 star 支持一下。 UI 的需求是雪花下落的方...',
    isCollected: false
  },
  {
    collectionCount: 15,
    ...
    user: {
      ...
      username: '吾乃上将军邢道荣',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2019/2/21/1691004fbff04e8c?w=406&h=240&f=jpeg&s=10568',
    ...
    viewsCount: 458,
    summaryInfo:
      'springboot作为一个基于spring开发的框架，自然也继承了spring的容器属性。容器中的bean自然成为了springboot各种功能的基础。本节就来分析一下springboot如何将各种bean加载进容器中。 开始分析之前首先我们先概览一下springboot框架究竟加载了多少bea...',
    isCollected: false
  },
  {
    collectionCount: 51,
    ...
    user: {
      community: {
        weibo: {
          ...
          username: '简书胡七筒',
          avatarLarge:
            'http://tva3.sinaimg.cn/crop.0.0.100.100.180/0063pvX2jw8epzq9gtxs7j302s02sq2r.jpg'
        },
        wechat: {
          avatarLarge:
            'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83epYE0fu1icDZPRU5Lw4oZ4PT3v0FqtrJH5OEU9iaeSd7hgXAVmonmKIaqC8qf4gtI96fNuw8bJaCWtg/132'
        }
      },
      ...
      username: '胡七筒',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/11/6/166e86bef47561bd?w=1080&h=1080&f=jpeg&s=128436',
    ...
    hotIndex: 3495.6576,
    content:
      '盛夏已来，街边烧烤店的生意日渐红火，光着膀子吃串喝扎啤的人多了起来。 午夜时分，下了地铁，我便拉着华妹在马路上时而狂奔飞驰，时而闲庭信步。午夜压马路对于交流感情很有帮助，言语中满是亲昵的味道。 在路过一家便利店时，我以请华妹吃伊利小布丁为由，进店偷偷买了盒小杜塞进兜里，以备不时…',
    ...
    viewsCount: 2683,
    summaryInfo:
      '盛夏已来，街边烧烤店的生意日渐红火，光着膀子吃串喝扎啤的人多了起来。 午夜时分，下了地铁，我便拉着华妹在马路上时而狂奔飞驰，时而闲庭信步。午夜压马路对于交流感情很有帮助，言语中满是亲昵的味道。 在路过一家便利店时，我以请华妹吃伊利小布丁为由，进店偷偷买了盒小杜塞进兜里，以备不时之需。 在漫步了几个...',
    isCollected: false
  },
  {
    collectionCount: 19,
    ...
    user: {
      ...
      username: 'aoho',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/1/17/16104a64f70fcc44?w=368&h=368&f=jpeg&s=63519',
    ...
    viewsCount: 528,
    summaryInfo:
      '在前面的文章，我们介绍了。Go module支持了Versioned Go，并初步解决了包依赖管理的问题。 新的工作模式也带来了一些问题，在大陆地区我们无法直接通过 命令获取到一些第三方包，最常见的就是 下面的各种优秀的包。一旦工作在模块下， 将不再关心 GOPATH 或是 vendor 下的包，...',
    isCollected: false
  },
  {
    collectionCount: 85,
    ...
    user: {
      community: {
        weibo: {
          avatar_url:
            'http://tva1.sinaimg.cn/crop.0.0.200.200.180/005SpQEcjw8f6iv9rb0dej305k05kwee.jpg',
          uid: '5384746884',
      ...
      avatarLarge:
        'https://leancloud-gold-cdn.xitu.io/NhcImRe2HnZEbWrYkIn3I90MuAQ6KcHjwyP4VBFE',
      objectId: '587a050661ff4b0065f1951c'
    },
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/19/16995cc1fa4bb5ea?w=500&h=317&f=jpeg&s=10749',
    original: true,
    hotIndex: 2084.8986,
    content:
      '本文首先描述笔者所处的项目组的 Web 打印项目的需求背景，然后描述笔者在实践 Web 打印项目的过程中遇到了诸多问题，阐述 Web 打印的问题解决思路，最后给出了另外一种 Web 打印的需求解决方案，即使用Headless browser生成图片并打印的方案。预计阅读时间5 …',
    title: 'Web打印探秘',
    ...
    viewsCount: 1187,
    summaryInfo:
      '本文首先描述笔者所处的项目组的 Web 打印项目的需求背景，然后描述笔者在实践 Web 打印项目的过程中遇到了诸多问题，阐述 Web 打印的问题解决思路，最后给出了另外一种 Web 打印的需求解决方案，即使用生成图片并打印的方案。预计阅读时间5 ~ 10分钟。 于是，为了解决上述需求，笔者大概写了...',
    isCollected: false
  },
  {
    collectionCount: 26,
    ...
    hotIndex: 697.4028,
    content:
      '数据结构和算法的知识博大精深, 这里只是对这几种数据结构做一些简单的介绍。并对leetcode上部分相关的简单和中等题做出解答。还请各位看官见谅 二叉树是一种典型的树状结构, 二叉树每一个节点最多有两个子树的结构。以下是遍历二叉树的几种方式, 总的来说使用递归的方式, 还是非常…',
    ...
    viewsCount: 355,
    summaryInfo:
      '数据结构和算法的知识博大精深, 这里只是对这几种数据结构做一些简单的介绍。并对leetcode上部分相关的简单和中等题做出解答。还请各位看官见谅 二叉树是一种典型的树状结构, 二叉树每一个节点最多有两个子树的结构。以下是遍历二叉树的几种方式, 总的来说使用递归的方式, 还是非常好理解的。 前序遍历...',
    isCollected: false
  },
  {
    collectionCount: 16,
    ...
    user: {
      community: {
        weibo: {
          ...
          username: '子曰五溪',
          avatarLarge:
            'http://tvax1.sinaimg.cn/crop.0.0.1002.1002.180/9261b2d6ly8fu7s604og1j20ru0ruq45.jpg'
        },
        github: {
          username: 'icepy',
    ...
    author: '',
    screenshot:
      'https://user-gold-cdn.xitu.io/2019/3/19/169945304b92687a?w=1490&h=828&f=png&s=60788',
    original: true,
    hotIndex: 668.0468,
    content:
    ...
    viewsCount: 506,
    summaryInfo:
      '这篇文章的出发点是为了帮助前端开发者串联 ES6前后的 JavaScript 知识，并且可以快速了解 JavaScript 语言的最新进展。 JavaScript 在当下处于特权地位，因为它是唯一可以在浏览器中运行的语言，并且是被高度集成和优化过的。 JavaScript 在未来有着极好的发展空间...',
    isCollected: false
  },
  {
    collectionCount: 26,
    ...
    user: {
      ...
      username: '腾讯云加社区',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2017/12/15/1605950722bb7b3e?w=659&h=640&f=jpeg&s=43951',
    ...
    viewsCount: 917,
    summaryInfo:
      '在定位外网问题时，最怕的是遇到无法复现或者是偶现的问题，我们无法在用户的设备上通过抓包、打断点或日志来分析问题，只能靠仅有的页面截图和用户的片面描述作为线索。此时，也只能结合“猜想法”和“排除法”进行分析定位，排查了半天也很有可能没有结果，最后只能回复“可能是缓存或者app的原因，请清下缓存或者重...',
    isCollected: false
  },
  {
    collectionCount: 12,
    ...
    user: {
      community: {
        wechat: {
          avatarLarge:
            'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKr3ZPRg8ECLu7JicPa3LC5DBH9McEtiaGzicdiaibWCvOykfd7XkeZ0qQzIxFiaDnJts8TRPlG4uX6NwmA/132'
        },
        github: {
      ...
      username: '玉儿Qi',
      avatarLarge:
        'https://user-gold-cdn.xitu.io/2018/4/9/162a78bb26356d08?w=720&h=1008&f=jpeg&s=305747',
    ...
    viewsCount: 275,
    summaryInfo:
      '“一张照片包含了万千信息”，这句话常常被人们引用。但是一张图能表达的信息要更多。以图的形式可视化数据，帮助我们获得了更可行的见解，并基于此作出更好的数据驱动的决策。 但是，为了真正理解图到底是什么，以及为什么我们要使用它，我们还需要知道图论的概念。知道了这个，可以帮助我们更好的编程。 如果你之前曾...',
    isCollected: false
  }
]
    ...
    return (
      <div>
        ...
        <div className="entryList" style={{marginTop: "43px"}}>
            <PullDownRefresh dataSource={dataSource}/>
        </div>
      </div>
    )
  }
